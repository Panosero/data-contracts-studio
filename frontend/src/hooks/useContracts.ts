...
export const useContracts = (params: ContractsListParams = {}) => {
  return useQuery(['contracts', params], () => ContractService.getContracts(params), {
...
export const useCreateContract = () => {
  ...
  return useMutation((contract: DataContractCreate) => ContractService.createContract(contract), {
    onSuccess: () => {
...
export const useAutoGenerateFields = () => {
  return useMutation((request: AutoGenerateRequest) => ContractService.autoGenerateFields(request));
};
